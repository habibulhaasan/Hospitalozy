...
/* ------------------------------------------------------------------ *
 * Reusable searchable dropdown (combobox). Supports free typing —
 * if nothing in the option list matches, whatever was typed is still
 * used as the value (so "Self", a new doctor, etc. all work without
 * the list needing to contain it first).
 * ------------------------------------------------------------------ */
function SearchableSelect({ value, onChange, options, placeholder, emptyHint }) {
